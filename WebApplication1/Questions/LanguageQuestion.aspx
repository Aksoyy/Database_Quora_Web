<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="LanguageQuestion.aspx.cs" Inherits="WebApplication1.WebForm14" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     Dile Göre Sorular<table>
        <tr>
            ...
            <td>
                <asp:Button ID="btGetLanguage" runat="server" Text="Soruları Getir" OnClick="btGetLanguage_Click" /></td>
        </tr>
    </table>
